        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Descubra, ouça e compartilhe podcasts incríveis de criadores do mundo todo. Sua porta de entrada para
              conteúdo de áudio ilimitado.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-muted-foreground">contato@playcast.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-8 pt-8 lg:mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground text-center md:text-left">
              © {new Date().getFullYear()} PlayCast. Todos os direitos reservados.
            </p>
