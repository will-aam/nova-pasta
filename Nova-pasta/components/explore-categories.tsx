...
const categoryEpisodes: CategoryEpisode[] = [
  ...
  },
  {
    ...
    description: "Como a IA está transformando o mundo e o que podemos esperar para os próximos anos.",
  ...
  },
  {
    ...
    description: "Estratégias práticas para construir patrimônio e alcançar a independência financeira.",
    tags: ["investimentos", "patrimônio", "finanças", "independência", "estratégias"],
  },
  {
    id: 4,
    category: "Psicologia",
    title: "A Mente e as Emoções",
    description: "Entenda como funciona nossa mente e aprenda a lidar melhor com suas emoções.",
  ...
  },
  {
    ...
    description: "As competências essenciais para ser um líder eficaz na era digital.",
  ...
  },
  {
    ...
    description: "Como manter-se sempre aprendendo e se adaptando às mudanças do mundo moderno.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Encontre episódios organizados por temas que mais interessam você. Conteúdo curado para cada área do
            conhecimento.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {categoryEpisodes.slice(0, visibleCount).map((episode) => (
            <Card key={episode.id} className="h-full hover:shadow-lg transition-shadow">
              <CardHeader>
        ...
        {categoryEpisodes.length > 2 && (
          <div className="text-center mt-12">
            <Button variant="outline" size="lg" onClick={handleShowMore} className="gap-2 bg-transparent">
